...
## ABOUT ME:<br>
I’m currently in school pursuing a BSc in Computer Science / Software Engineering. I'm finishing up my sophomore year, getting ready to transfer to a university. I'm the president of my school's Programming Association.. I'm also secretary of WiCyS, the school's cybersecurity club. I've previously completed additional learning pathways such as Harvard's CS50 and The Odin Project's Javascript Pathway. I also participate in various cybersecurity competitions with the school team such as the Collegiate Cyber Defense Competition. I try to help out and engage with local programming communities both in Whatcom County and Seattle as often as possible. I'm spending whatever free time I have left dabbling in Python, microcontrollers, and exploring experimental visualization and signal processesing with Max MSP, Touchdesigner & Juce.

I'm currently developing a standalone steganography application in Python which employs a full GUI via PySide6. This allows the user to encode a media file (such as an image or txt file) into another form of media (such as image or audio files), thereby concealing the original message into a carrier message. This has been a great opportunity into exploring the techniques and tools critical to scalable software architecture and design, digital media manipulation, GUI frameworks, and cryptography.

I’m interested in studying computer science, machine learning, and programming in order to try to make the world a better and more enjoyable place to live. I'm interested in both music and the environment, and looking for innovative ways to integrate forward thinking technologies into these areas.
